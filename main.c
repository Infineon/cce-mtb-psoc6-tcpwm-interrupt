...
* File Name:   main.c
*
* Description: This is the source code for the PSoC 6 MCU TCPWM Interrupt
...
#define TIMER_PERIOD_MSEC   1538U
...
void timer_interrupt_handler(void)
{
    ...
    /* Toggle the LED */
    Cy_GPIO_Inv(CYBSP_LED_RGB_RED_PORT, CYBSP_LED_RGB_RED_NUM);
}
/*******************************************************************************
* Function Name: main
********************************************************************************
...
int main(void)
{
    ...
    /* Initialize the TCPWM component in timer/counter mode. The return value
     *  of the function indicates whether the arguments are valid or not.
     */
    result = Cy_TCPWM_Counter_Init(CYBSP_TIMER_HW, CYBSP_TIMER_NUM,
             &CYBSP_TIMER_config);
    ...
    if (0UL != (CY_TCPWM_INT_ON_TC & Cy_TCPWM_GetInterruptMask(CYBSP_TIMER_HW,
                CYBSP_TIMER_NUM)))
    {
        Cy_TCPWM_SetInterrupt(CYBSP_TIMER_HW, CYBSP_TIMER_NUM,
                             CY_TCPWM_INT_ON_TC);
    }
     ...
     * set to N-1.
     */
    Cy_TCPWM_Counter_SetPeriod(CYBSP_TIMER_HW, CYBSP_TIMER_NUM,
                               TIMER_PERIOD_MSEC-1 );
